// const departuresOld = [494, 499, 500, 517, 520, 523, 530, 556, 563, 576, 586, 613, 625];
// for(let i = 0; i < departuresOld.length; i++) {
//     let hours = Math.floor(departuresOld[i] / 60); //this  return hours
//     let minutes = departuresOld[i] % 60; //this returns
//     let finalTime = hours + ":" + minutes;
    
//     document.querySelector(".trainTimes").innerHTML += `<tr><td>${hours}:${minutes}</td></tr>`
//   }
